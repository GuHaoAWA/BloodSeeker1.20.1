...
public class Entities {
    ...
    public static final RegistryObject<EntityType<ApartEntity>> APART = register("apart",
            EntityType.Builder.<ApartEntity>of(ApartEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(1000).noSave().fireImmune()
    ...
    public static void init(FMLCommonSetupEvent event) {
        event.enqueueWork(ApartEntity::init);
    }
