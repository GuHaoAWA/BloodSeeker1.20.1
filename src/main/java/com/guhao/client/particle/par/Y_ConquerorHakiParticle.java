...
@OnlyIn(Dist.CLIENT)
public class Y_ConquerorHakiParticle extends TexturedCustomModelParticle {
    private LivingEntityPatch<?> caster;

    public Y_ConquerorHakiParticle(ClientLevel level, double x, double y, double z, double xd, double yd, double zd, RawMesh particleMesh, ResourceLocation texture) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType typeIn, @NotNull ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new Y_ConquerorHakiParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, ESClientModels.CONQUEROR_HAKI, new ResourceLocation("guhao", "textures/models/particle/y_conqueror_haki.png"));
        }
    }
}
