...
@OnlyIn(Dist.CLIENT)
public class ConquerorHakiFloorParticle extends TexturedCustomModelParticle {
    private LivingEntityPatch<?> caster;

    public ConquerorHakiFloorParticle(ClientLevel level, double x, double y, double z, double xd, double yd, double zd, RawMesh particleMesh, ResourceLocation texture) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType typeIn, @NotNull ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new ConquerorHakiFloorParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, ESClientModels.CONQUEROR_HAKI_FOOR, new ResourceLocation("guhao", "textures/models/particle/conqueror_haki.png"));
        }
    }
}
