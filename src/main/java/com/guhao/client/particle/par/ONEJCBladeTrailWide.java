...
import static com.dfdyz.epicacg.client.render.EpicACGRenderType.getBloomRenderTypeByTexture;
import static net.minecraft.util.Mth.nextFloat;

@OnlyIn(Dist.CLIENT)
public class ONEJCBladeTrailWide extends SingleQuadParticle {
    protected float timeOffset;
    protected final double X,Y,Z;

    public ONEJCBladeTrailWide(ClientLevel level, double x, double y, double z, double rx, double ry, double rz) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            return new ONEJCBladeTrailWide(worldIn,x,y,z,xSpeed,ySpeed,zSpeed);
        }
    }
}
